...
public class CascadeTypeMergeTest extends EntityManagerTest {
    ...
    public void atualizarProdutoComCategoria() {
        ...
        produto.setCategorias(Collections.singletonList(categoria)); // CascadeType.MERGE
    ...
    public void atualizarPedidoComItens() {
        ...
        pedido.setItensPedido(Collections.singletonList(itemPedido)); // CascadeType.MERGE
    ...
    public void atualizarItemPedidoComPedido() {
        ...
        pedido.setItensPedido(Collections.singletonList(itemPedido));
