...
insert into item_pedido (pedido_id, produto_id, preco_produto, quantidade) values (1, 1, 499.0, 1);

insert into pagamento(pedido_id, status, numero_cartao) values(2, 'PROCESSANDO', '1234');
